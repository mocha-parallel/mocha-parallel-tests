...
import RequireCacheWatcher from './require-cache-watcher';
...
const scheduleMochaRun = ({file, options}, cacheWatcher) => {
...
export const runTests = ({options, throttledCalls, callback}) => {
    ...
    while (pendingTests.length) {
        ...
        const fileRunners = scheduleMochaRun({file: testFile, options, callback}, cacheWatcher);
